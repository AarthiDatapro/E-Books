...
import { getProductDetailsRoute, secretKey } from '../../utils/APIRoutes';
...
function ProductDetail() {
    ...
    const handleAddToCart = () => {
        ...
        if (!productExists) {
            ...
            // Trigger update for all other components
    ...
    const handleRequestSample = async () => {
        ...
        try {
            if (!product.restricted) {
                ...
                toast.error("This book is restricted, you cannot download the full version directly.", toastOptions);
            }
        } catch (err) {
                ...
                {product ? (
                    <div className="product-detail-card">
                        ...
                        <div className="product-info">
                            ...
                            <p id='productdetail-discPrice'><b>MRP:</b> ₹{product.discPrice}</p>
